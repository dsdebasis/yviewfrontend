const ChannelHeading = () => {
  return (
      ...
      <section className=' w-full my-4 bg-gradient-to-br from-slate-600 to-slate-700 shadow-xl   rounded-xl text-white p-2  grid  gap-y-2 md:gap-x-10 md:h-[35vh] md:grid-cols-4  '>
        ...
        <section className=' md:mx-10  md:col-span-2  grid grid-rows-3  md:gap-y-5 '>
          <div className=' bg-gradient-to-bl  from-blue-500 to-indigo-800 flex justify-around  items-center rounded-lg '>
            <h1>subscriber</h1>
            <h1>videos</h1>
            <h1>views</h1>
          </div>

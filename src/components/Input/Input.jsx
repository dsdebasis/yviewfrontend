...
const Input = ({ id,type,name, disabled,placeholder,value,required,fun,submitFun,css}) => {
  return (
    <input type={type} name={name}  placeholder={placeholder} disabled={disabled}  value={value} required={required || true} onChange={fun} onSubmit={submitFun} className={`w-full h-10

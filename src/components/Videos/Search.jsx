  ...
  return (
    <section className='w-full  rounded-lg  flex  gap-y-4 flex-row md:flex-row md:justify-between'>
      <div className='h-[10%] max-w-[60%] my-2  ml-14 md:flex md:justify-center'>
        <input type='text' placeholder='search your videos ' className='h-full w-full md:w-[30vw] outline-none  p-2 bg-transparent  border-x-2 rounded-xl  focus:border-yellow-400  text-white' />
      </div>

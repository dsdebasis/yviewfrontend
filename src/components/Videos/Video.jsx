...
const Video = ({title,uploadTime,src,vid,channelProfilePic,videoOwner,thumbnail,duration}) => {
  
  return (
    <div className=' overflow-hidden rounded-xl w-full md:w-[90%]  lg:w-[95%]  grid grid-flow-row  gap-y-4  md:px-0 '>
      <VideoDetails src={src} vid={vid} thumbnail={thumbnail} duration={duration}/>
